...
@Component({
      ...
      <div class="wimp">
        ...
        @if (step() === 'upload') {
          <div class="wimp-panel">
            ...
            <div class="wimp-cols">
              <div class="wimp-cols__group wimp-cols__col--a">
              ...
              <div class="wimp-cols__group wimp-cols__col--b wimp-cols__cell--right">
              ...
              <div class="wimp-cols__row wimp-cols__col--a"><span class="wimp-cols__key">Documento</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Número do documento</span></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Placa</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Placa do veículo</span></div>

              <div class="wimp-cols__row wimp-cols__col--a"><span class="wimp-cols__key">Tipo de documento</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Lista: CPF, RG, Passaporte</span></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Marca</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Fabricante</span></div>

              <div class="wimp-cols__row wimp-cols__col--a"><span class="wimp-cols__key">Nome completo</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Nome do colaborador</span></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Modelo</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Modelo</span></div>

              <div class="wimp-cols__row wimp-cols__col--a"><span class="wimp-cols__key">Função / Cargo</span><span class="wimp-tag wimp-tag--req">Obrigatório</span><span class="wimp-cols__desc">Lista de funções do sistema</span></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Motorista (documento)</span><span class="wimp-tag wimp-tag--opt">Opcional</span><span class="wimp-cols__desc">Documento de um colaborador da aba ao lado</span></div>

              <div class="wimp-cols__row wimp-cols__col--a"><span class="wimp-cols__key">RG</span><span class="wimp-tag wimp-tag--opt">Opcional</span><span class="wimp-cols__desc">RG</span></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Cor</span><span class="wimp-tag wimp-tag--opt">Opcional</span><span class="wimp-cols__desc">Lista de sugestão</span></div>

              <div class="wimp-cols__row wimp-cols__col--a"><span class="wimp-cols__key">Telefone</span><span class="wimp-tag wimp-tag--opt">Opcional</span><span class="wimp-cols__desc">Telefone com DDD</span></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Tipo</span><span class="wimp-tag wimp-tag--opt">Opcional</span><span class="wimp-cols__desc">Lista de sugestão</span></div>

              <div class="wimp-cols__row wimp-cols__col--a wimp-cols__row--empty" aria-hidden="true"></div>
              <div class="wimp-cols__row wimp-cols__col--b wimp-cols__cell--right"><span class="wimp-cols__key">Observações</span><span class="wimp-tag wimp-tag--opt">Opcional</span><span class="wimp-cols__desc">Texto livre</span></div>
            </div>
                  ...
                  <div class="wimp-entity__head">
                    ...
                    <div>
                      ...
                      <div class="wimp-entity__sub">
                        {{ row.chave.tipo }} · {{ row.chave.documento }}{{ vinculoSuffix(row) }}
                      </div>
                    </div>
                  </div>
                  @if (row.cadastro === 'erro') {
        ...
        <div class="wimp-foot__right">
          ...
          @if (step() === 'review') {
            <button type="button" class="wimp-btn wimp-btn--primary" [disabled]="busy() || !hasCommitable()" (click)="runConfirm()">
              {{ busy() ? 'Importando...' : 'Adicionar ao acesso' }}
            </button>
          }
  ...
  styles: [
    `
      ...
      .wimp-cols__cell--right { border-left: 1px solid var(--line); }
      .wimp-cols__group {
      ...
      .wimp-cols__row {
        ...
        column-gap: 10px; row-gap: 4px; align-content: center; align-items: center;
        padding: 9px 14px; font-size: 13px; border-top: 1px solid var(--line);
        min-height: 100%;
      }
      .wimp-cols__row--empty { background: #fff; }
      .wimp-cols__key {
        font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: 12px;
        background: #f2f3f8; padding: 2px 7px; border-radius: 6px; justify-self: start;
      }
      .wimp-cols__desc { grid-column: 1 / -1; font-size: 12px; color: var(--ink-2); }
      .wimp-tag {
        justify-self: end; align-self: center; font-size: 11px; font-weight: 600; padding: 2px 9px;
      ...
      .wimp-dropzone:hover, .wimp-dropzone.is-drag { border-color: var(--wtorre); background: var(--wtorre-soft); }
      .wimp-dropzone__icon {
        width: 40px; height: 40px; border-radius: 10px; background: var(--wtorre-soft); color: var(--wtorre);
        display: grid; place-items: center; margin-bottom: 6px;
      }
      .wimp-dropzone__icon svg { width: 20px; height: 20px; }
      .wimp-dropzone__title { font-size: 14px; font-weight: 600; }
      .wimp-dropzone__hint { font-size: 12px; color: var(--ink-3); }
      ...
      @media (max-width: 720px) {
        .wimp-cols { grid-template-columns: 1fr; }
        .wimp-cols__cell--right { border-left: none; }
        .wimp-cols__col--a { order: 1; }
        .wimp-cols__col--b { order: 2; }
        .wimp-cols__group.wimp-cols__col--b { border-top: 1px solid var(--line); }
        .wimp-cols__row--empty { display: none; }
      }
...
export class ServiceAccessBulkImportWizardComponent {
  @Input({ required: true }) open = false;
  @Input({ required: true }) serviceAccessId!: number;
  @Input() accessName = '';
  @Input() companyName = '';
  ...
  private initDecisions(prev: UnifiedBulkPreviewResult) {
    ...
    for (const row of prev.colaboradores) {
      ...
      col[row.linha] = { include: true, camposMaster, aplicarFuncao: true };
    }
  ...
  runConfirm() {
    ...
    this.patrimonialService
      .bulkImportConfirm(this.serviceAccessId, prev.previewToken, { colaboradores, veiculos })
      .subscribe({
        next: (res) => {
          this.result.set(res);
          this.busy.set(false);
